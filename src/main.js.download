...
(function ($) {
  ...
  var zyan = {
    ...
    progressbar() {
      ...
      $(window).on("scroll", function () {
        ...
        if (progressbar.length > 0) {
          let oTop =
            $(".tf__team_skills_bar_single .fill").offset().top -
            window.innerHeight;
          if (scroll > oTop) {
            $(".tf__team_skills_bar_single .fill").addClass(
              "progressbar-active"
            );
          } else {
            $(".tf__team_skills_bar_single .fill").removeClass(
              "progressbar-active"
            );
          }
        }
    ...
    customMouse() {
      ...
      // link
      $("a,.c-pointer,button,.progress,.common_btn")
